...
static INLINE double sum(struct pair12 x);
...
static INLINE double sum(struct pair12 x) {
  return (left0(left1(left2(left3(left4(left5(left6(left7(left8(left9(left10(left11(left12(x)))))))))))))+
	  right0(right1(right2(right3(right4(right5(right6(right7(right8(right9(right10(right11(right12(x))))))))))))));}
...
int main(void) {
  printf("%f\n", sum(swap12(tree12(tree11(tree10(tree9(tree8(tree7(tree6(tree5(tree4(tree3(tree2(tree1(tree0(read_real()))))))))))))))));}
